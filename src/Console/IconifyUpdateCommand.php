 ...
 */
#[AsCommand(name: 'iconify:update', description: 'Update existing icon packages for the application.')]
class IconifyUpdateCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'iconify:update {--packages= : Comma-separated list of icon package names to update (e.g. si,ph,mdi)}';
     ...
     * @var string
     */
    protected $description = 'Update existing icon packages for the application.';
