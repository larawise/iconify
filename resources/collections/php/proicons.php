...
return [
    ...
    'aliases' => [
        ...
        'add-square-multiple-var' => [
            'parent' => 'add-square-multiple',
        ],
        'apps-list' => [
            'parent' => 'checkbox-list',
        ],
        'arrow-foward' => [
            'parent' => 'arrow-forward',
        ],
        'arrow-up-down-1' => [
            'parent' => 'arrow-left-right',
        ],
        'attatch' => [
            'parent' => 'attach',
        ],
        ...
        'text-bullet-list-square' => [
            'parent' => 'bullet-list-square',
        ],
        'text-bullet-list-square-add' => [
            'parent' => 'bullet-list-square-add',
        ],
        'text-bullet-list-tree' => [
            'parent' => 'bullet-list-tree',
        ],
        'volume-0' => [
            'parent' => 'volume',
        ],
